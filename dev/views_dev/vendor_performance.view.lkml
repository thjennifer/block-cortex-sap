view: vendor_performance {
  ...
  dimension: pk {
    ...
    primary_key: yes
    hidden: yes
    sql:  concat(${client_mandt},${document_number_ebeln},${item_ebelp},${language_key});;
  }
  ...
  measure: sum_invoice_amount_in_target_currency_by_top_vendor {
    ...
    link: {
      ...
      url: "/dashboards/cortex_sap_operational_prod::sap_finance_sa_08_a_spend_by_top_vendors?Company+Code={{ _filters['vendor_performance.company_text_butxt']| url_encode }}&Purchasing+Organization={{ _filters['vendor_performance.purchasing_organization_text_ekotx']| url_encode }}&Purchasing+Group={{ _filters['vendor_performance.purchasing_group_text_eknam']| url_encode }}&Vendor+Name={{ _filters['vendor_performance.name1']| url_encode }}&Vendor+Country={{ _filters['vendor_performance.country_key_land1']| url_encode }}&Target+Currency={{ _filters['vendor_performance.target_currency_tcurr']| url_encode }}&Invoice+Date={{ _filters['vendor_performance.Invoice_date_date']| url_encode }}"
    }
    hidden: no
  }
